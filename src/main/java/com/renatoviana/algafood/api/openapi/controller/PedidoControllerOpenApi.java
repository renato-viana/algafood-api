...
public interface PedidoControllerOpenApi {
    ...
    public Page<PedidoResumoModelResponse> pesquisar(PedidoFilter filtro, Pageable pageable);

    @ApiOperation("Registra um pedido")
    @ApiResponses({
            @ApiResponse(code = 201, message = "Pedido registrado"),
    })
    public PedidoModelResponse adicionar(
    ...
    public PedidoModelResponse buscar(
