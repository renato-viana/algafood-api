...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// 3. Então, especializamos o método handleTypeMismatch e verificamos se a exception é uma instância de
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
		...
		// Importante colocar o printStackTrace (pelo menos por enquanto, que não estamos fazendo logging) para mostrar
		// a stacktrace no console
		// Se não fizer isso, você não vai ver a stacktrace de exceptions que seriam importantes para você durante,
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, detail).fields(problemFields).userMessage(detail)
				.build();
